...
async function ensureLumiModOverridesLoaded() {
  ...
  return new Promise((resolve, reject) => {
    ...
    script.src = `./vanilla_exports/luminescent_platinum_mod_overrides.js?v=${APP_ASSET_VERSION}`;
...
function ensureVanillaScriptLoaded(slug) {
  return new Promise((resolve, reject) => {
    ...
    const script = document.createElement('script');
    script.src = `./vanilla_exports/${slug}.js?v=${APP_ASSET_VERSION}`;
