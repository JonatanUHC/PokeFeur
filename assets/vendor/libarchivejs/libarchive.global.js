var LibArchiveGlobal = (() => {
  ...
  // assets/vendor/libarchivejs/libarchive.js
  var libarchive_exports = {};
  __export(libarchive_exports, {
    Archive: () => O,
    ArchiveCompression: () => k,
    ArchiveFormat: () => _
  });
  var import_meta = {};
  var e = /* @__PURE__ */ Symbol("Comlink.proxy");
  var t = /* @__PURE__ */ Symbol("Comlink.endpoint");
  var n = /* @__PURE__ */ Symbol("Comlink.releaseProxy");
  var r = /* @__PURE__ */ Symbol("Comlink.finalizer");
  var i = /* @__PURE__ */ Symbol("Comlink.thrown");
  ...
  function o(e2, t2 = globalThis, n2 = ["*"]) {
    t2.addEventListener("message", (function s2(a2) {
      ...
      if (!(function(e3, t3) {
        ...
        return false;
      })(n2, a2.origin)) return void console.warn(`Invalid origin '${a2.origin}' for comlink proxy`);
  ...
  function d(e2, r2 = [], i2 = function() {
    ...
    const a2 = new Proxy(i2, { get(t2, i3) {
      ...
      if (o2 === t) return E(e2, { type: "ENDPOINT" }).then(v);
  ...
  function y(e2) {
    for (const [t2, n2] of a) if (n2.canHandle(e2)) {
  ...
  function b(e2) {
    if (e2 instanceof File || e2 instanceof R || null === e2) return e2;
    const t2 = {};
    for (const n2 of Object.keys(e2)) t2[n2] = b(e2[n2]);
    return t2;
  }
  function P(e2, t2 = "") {
    const n2 = [];
    for (const r2 of Object.keys(e2)) e2[r2] instanceof File || e2[r2] instanceof R || null === e2[r2] ? n2.push({ file: e2[r2] || r2, path: t2 }) : n2.push(...P(e2[r2], `${t2}${r2}/`));
    return n2;
  }
  function S(e2, t2) {
    const n2 = t2.split("/");
  ...
  return __toCommonJS(libarchive_exports);
})();
/**
 * @license
